from analyses.cartography.export import export_raw_gpkg, copy_qgis_project
from analyses.cartography.qgis_launcher import launch_qgis_render
...
def run_cartography(synthese_queries, output_dirs, area_name):
    ...
    gpkg_path = output_dirs["data"] / "raw.gpkg"
    export_raw_gpkg(raw, gpkg_path)
